...
This R function created by including relevant inputs and defining the constraints that describes under the Model. This function provides the following outputs:
...
Here, we input data manually. Also, you can define data and call it and run. Required library: lpSolve.
...
This R function created by including demand and release which obtained by previous code. This function provides the following outputs:
...
This function provides graphical representation of the release in order to months. x - axis denotes the months and y - axis denotes release in cubic meters. Required library: ggplot2.
...
This function provides graphical representation of the release and demand in order to months. x - axis denotes the months and y - axis denotes volume in cubic meters. Required library: ggplot2.
